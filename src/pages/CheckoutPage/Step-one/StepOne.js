        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='form-row'>
                    ...
                    <input className='form-input' type="text" id="street" name="street" onChange={handleStreetAddress}/>
                ...
                <div className='form-row'>
                    ...
                    <input className='form-input' type="text" id="street" name="city" onChange={handleCityChange}/>
                ...
                <div className='form-row'>
                    ...
                    <input className='form-input' type="text" id="street" name="street" onChange={handlePostalCode}/>
